...
$keperluanLabel = $letterKind === 'izin' ? 'Keperluan Pelaksanaan Hilirisasi' : 'Luaran Wajib';
...
$isContractHilirisasi = $letterKind === 'kontrak';
$canHeadDirectEdit = !$isContractHilirisasi
    && $isHeadPanel
...
function detail_text_clean(string $value): string
{
    ...
    $normalizeOutputToken = static function (string $token): string {
        ...
        if (preg_match('/^[a-z0-9_]+$/i', $raw) === 1 && str_contains($raw, '_')) {
        ...
        <div class="col-lg-8">
                ...
                <?php if ($isHeadEditMode): ?>
                    ...
                    <div class="form-section-card mb-3">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-6"><div class="profile-info-item"><div class="profile-info-label">Skema Hilirisasi</div><div class="profile-info-value"><?= htmlspecialchars((string) (($detail['skema'] ?? '') !== '' ? $detail['skema'] : '-'), ENT_QUOTES, 'UTF-8'); ?></div></div></div>
                            <div class="col-md-6"><div class="profile-info-item"><div class="profile-info-label">Ruang Lingkup Hilirisasi</div><div class="profile-info-value"><?= htmlspecialchars((string) (($detail['ruang_lingkup'] ?? '') !== '' ? $detail['ruang_lingkup'] : '-'), ENT_QUOTES, 'UTF-8'); ?></div></div></div>
                            <div class="col-md-6"><div class="profile-info-item"><div class="profile-info-label">Sumber Dana</div><div class="profile-info-value"><?= detail_value($detail, 'funding_source'); ?></div></div></div>
                            <div class="col-md-6"><div class="profile-info-item"><div class="profile-info-label"><?= htmlspecialchars($labels['year'], ENT_QUOTES, 'UTF-8'); ?></div><div class="profile-info-value"><?= detail_value($detail, 'research_year'); ?></div></div></div>
                            <div class="col-md-6"><div class="profile-info-item"><div class="profile-info-label">Total Dana Disetujui</div><div class="profile-info-value"><?= htmlspecialchars(detail_currency((string) ($detail['total_dana_disetujui'] ?? '')), ENT_QUOTES, 'UTF-8'); ?></div></div></div>
                    ...
                    <form method="post" action="<?= htmlspecialchars($editFormAction, ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data" class="form-section-card mb-3">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <?php else: ?>
                                <input type="hidden" name="start_date" value="<?= htmlspecialchars((string) ($detail['start_date'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                                <input type="hidden" name="end_date" value="<?= htmlspecialchars((string) ($detail['end_date'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                            <?php endif; ?>
                ...
                <?php else: ?>
                    <form method="post" action="<?= htmlspecialchars($editFormAction, ENT_QUOTES, 'UTF-8'); ?>" enctype="multipart/form-data" class="form-section-card mb-3">
                        ...
                        <div class="row g-3 mt-1">
                            ...
                            <div class="col-md-4"><label class="form-label">Sumber Dana</label><input type="text" name="funding_source" class="form-control modern-input" value="<?= htmlspecialchars((string) ($detail['funding_source'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" readonly></div>
                            <div class="col-md-4"><label class="form-label">Tahun</label><input type="text" name="research_year" class="form-control modern-input" value="<?= htmlspecialchars((string) ($detail['research_year'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" readonly></div>
                            <div class="col-md-4"><label class="form-label">Total Dana Disetujui</label><input type="text" class="form-control modern-input" value="<?= htmlspecialchars(detail_currency((string) ($detail['total_dana_disetujui'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>" readonly></div>
            ...
            <div class="form-section-card mb-3">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-6">
                        <div class="profile-info-item">
                            <div class="profile-info-label">Skema Hilirisasi</div>
                            <div class="profile-info-value"><?= htmlspecialchars((string) (($detail['skema'] ?? '') !== '' ? $detail['skema'] : '-'), ENT_QUOTES, 'UTF-8'); ?></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="profile-info-item">
                            <div class="profile-info-label">Ruang Lingkup Hilirisasi</div>
                            <div class="profile-info-value"><?= htmlspecialchars((string) (($detail['ruang_lingkup'] ?? '') !== '' ? $detail['ruang_lingkup'] : '-'), ENT_QUOTES, 'UTF-8'); ?></div>
                        </div>
                    </div>
