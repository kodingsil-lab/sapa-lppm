...
$labels = [
    'penelitian' => [
        'page' => 'Detail Surat Tugas Penelitian',
        'subtitle' => 'Informasi lengkap pengajuan surat tugas penelitian pada sistem SAPA LPPM.',
    ...
    'hilirisasi' => [
        'page' => 'Detail Surat Tugas Pelaksanaan Hilirisasi',
        'subtitle' => 'Informasi lengkap pengajuan surat tugas pelaksanaan hilirisasi pada sistem SAPA LPPM.',
        'section' => 'Data Hilirisasi',
...
$label = $labels[$activityType] ?? $labels['penelitian'];
$taskSubject = match ($activityType) {
