...
$labels = [
    'penelitian' => [
        'activity' => 'Penelitian',
        'activity_list' => 'Penelitian Aktif',
        'title' => 'Judul Penelitian',
        'leader' => 'Ketua Peneliti',
        'members' => 'Anggota Peneliti',
        'scheme' => 'Skema Penelitian',
        'year' => 'Tahun Penelitian',
        'task_title' => 'Surat Tugas Penelitian',
        'task_button' => 'Ajukan Surat Tugas Penelitian',
        'empty' => 'Pilih data penelitian aktif terlebih dahulu untuk melanjutkan pengajuan surat tugas penelitian.',
        'location' => 'Lokasi Penugasan',
        'institution' => 'Instansi Tujuan',
        'description' => 'Deskripsi Kegiatan',
        'description_ph' => 'Contoh: Menjelaskan tahapan pelaksanaan penelitian mulai dari persiapan, pengumpulan data, analisis, hingga pelaporan.',
        'institution_ph' => 'Contoh: Dinas Pendidikan / Mitra Penelitian',
    ],
    'pengabdian' => [
        'activity' => 'Pengabdian',
        'activity_list' => 'Pengabdian Aktif',
        'title' => 'Judul Pengabdian',
        'leader' => 'Ketua Pelaksana',
        'members' => 'Anggota Pelaksana',
        'scheme' => 'Skema Pengabdian',
        'year' => 'Tahun Pengabdian',
        'task_title' => 'Surat Tugas Pengabdian',
        'task_button' => 'Ajukan Surat Tugas Pengabdian',
        'empty' => 'Pilih data pengabdian aktif terlebih dahulu untuk melanjutkan pengajuan surat tugas pengabdian.',
        'location' => 'Lokasi Pelaksanaan',
        'institution' => 'Instansi / Mitra Tujuan',
        'description' => 'Deskripsi Kegiatan',
        'description_ph' => 'Contoh: Menjelaskan tahapan pelaksanaan pengabdian mulai dari koordinasi, pelatihan/pendampingan, evaluasi, hingga pelaporan.',
        'institution_ph' => 'Contoh: Pemerintah Desa / Mitra Komunitas',
    ],
    'hilirisasi' => [
        'activity' => 'Hilirisasi',
...
<div class="submission-izin-layout">
    <div class="submission-stepper mb-3" aria-label="Alur pengajuan surat tugas">
        ...
        <div class="submission-stepper-item" data-task-step-item="2">
            ...
            <span class="submission-stepper-text"><?= htmlspecialchars(in_array($activityType, ['pengabdian', 'hilirisasi'], true) ? 'Data Pelaksana' : 'Data Peneliti', ENT_QUOTES, 'UTF-8'); ?></span>
        </div>
    ...
    <?php else: ?>
        <div class="submission-izin-preview mb-3">
            <h6 class="submission-izin-preview-title">Step 2 - <?= htmlspecialchars(in_array($activityType, ['pengabdian', 'hilirisasi'], true) ? 'Data Pelaksana' : 'Data Peneliti', ENT_QUOTES, 'UTF-8'); ?> (Auto)</h6>
        ...
        <form method="post" action="<?= htmlspecialchars($basePath . '/letters/store', ENT_QUOTES, 'UTF-8'); ?>" class="submission-izin-form">
            ...
            <div class="submission-izin-card mb-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label"><?= htmlspecialchars($label['institution'], ENT_QUOTES, 'UTF-8'); ?></label>
