...
<div class="page-content admin-profile-page master-form-page">
    <div class="profile-header mb-3">
        <div>
            <h1 class="page-title mb-1"><?= htmlspecialchars((string) ($pageTitle ?? 'Form Sumber Dana'), ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="page-subtitle mb-0"><?= htmlspecialchars((string) ($pageSubtitle ?? ''), ENT_QUOTES, 'UTF-8'); ?></p>
        </div>
        <a href="<?= htmlspecialchars($basePath . '/' . ltrim((string) ($backPath ?? 'master-data/sumber-dana'), '/'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary-main profile-back-btn">Kembali</a>
    </div>
    ...
    <div class="profile-card profile-detail-card master-form-page-card mt-3">
        <div class="section-head mb-3">
            <h3 class="section-title mb-0"><?= $isEdit ? 'Edit Sumber Dana' : 'Tambah Sumber Dana'; ?></h3>
        </div>
        <div>
            <form method="post" action="<?= htmlspecialchars($basePath . '/' . ltrim((string) ($savePath ?? 'master-data/sumber-dana/simpan'), '/'), ENT_QUOTES, 'UTF-8'); ?>" class="row g-3 master-form-grid">
                ...
                <div class="col-md-4 master-field-group">
                    ...
                    <small class="master-field-note">Sumber dana ini hanya muncul pada kategori kegiatan yang dipilih.</small>
                </div>
                <div class="col-md-4 master-field-group">
                    ...
                    <small class="master-field-note">Gunakan kode yang konsisten untuk kebutuhan internal.</small>
                </div>
                <div class="col-md-4 master-field-group">
                    <label class="form-label">Urutan</label>
                    <input type="number" min="1" name="sort_order" class="form-control profile-input" value="<?= (int) ($formValues['sort_order'] ?? 1); ?>">
                    <small class="master-field-note">Mengatur urutan tampil pada pilihan sumber dana.</small>
                </div>
                <div class="col-md-8 master-field-group">
                    ...
                    <small class="master-field-note">Nama ini tampil langsung pada form kegiatan dosen.</small>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12 master-field-group">
                    ...
                    <small class="master-field-note">Opsional, misalnya penjelasan sumber pendanaan atau catatan penggunaan.</small>
                </div>
                <div class="col-12 master-form-actions">
                    <a href="<?= htmlspecialchars($basePath . '/' . ltrim((string) ($backPath ?? 'master-data/sumber-dana'), '/'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-light-soft">Batal</a>
    ...
    <div class="profile-card profile-note-card mt-3">
        ...
        <p class="profile-note-text mb-0">Sumber dana yang aktif di sini akan menjadi pilihan pada form kegiatan sesuai kategori yang dipilih admin.</p>
    </div>
</div>
